...
sed -i 's|export KEY_ORG="Fort-Funston"|export KEY_ORG="S - H - U - N"|' /etc/openvpn/easy-rsa/2.0/vars
...
sed -i 's|export KEY_CN=changeme|export KEY_CN="S - H - U - N"|' /etc/openvpn/easy-rsa/2.0/vars
sed -i 's|export KEY_NAME=changeme|export KEY_NAME=server|' /etc/openvpn/easy-rsa/2.0/vars
sed -i 's|export KEY_OU=changeme|export KEY_OU=S - H - U - N|' /etc/openvpn/easy-rsa/2.0/vars
# create PKI
